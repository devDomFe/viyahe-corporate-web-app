...
export default function ConfirmationPage() {
  ...
  const { activeBooking, createBooking } = useMultiBooking();
  ...
  useEffect(() => {
    ...
    // Fallback to context for viewing submitted bookings
    if (activeBooking && activeBooking.status === 'submitted') {
  ...
  const handleNewSearch = () => {
    ...
    // Create a new booking and navigate to home
    createBooking();
    router.push('/');
  };
  ...
  // Show summary from context for submitted bookings
  if (isFromContext && activeBooking && activeBooking.status === 'submitted') {
    const flight = activeBooking.selectedFlight;
    const search = activeBooking.searchParams;
    const paxList = activeBooking.passengers;
          ...
          <VStack gap={{ base: '6', md: '8' }} align="stretch">
            ...
            <Box textAlign="center">
              ...
              <Text color="gray.600" fontSize="lg">
                This booking has been sent to our travel agents for review.
              </Text>
            </Box>
